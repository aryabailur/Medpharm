 ...
 *
 * Identical contract to vayu-api's client -- both sides call the same stateless
 * service, so the fallback maths must agree or the two apps would disagree
 * about the same institution's risk.
 *
