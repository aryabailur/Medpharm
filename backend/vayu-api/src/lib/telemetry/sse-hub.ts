 ...
 *
 * Sensor ingest publishes here; every browser subscribed to that shipment gets
 * the event. Deliberately in-memory: a single Fastify process serves the demo,
 * and Redis pub/sub would be infrastructure with no payoff at this scale.
