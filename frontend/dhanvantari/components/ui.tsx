/**
 * Terminal UI primitives — Dhanvantari.
 *
 * Deliberately identical to Vayu's. Both apps share ONE design system; they are
 * told apart by the header identity block, not by different components. A judge
 * sees two windows of the same product.
 *
...
export function ApiError({ error, service = 'dhanvantari-api' }: { error: string; service?: string }) {
  return (
