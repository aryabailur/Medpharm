      ...
      <head>
        ...
        <style>{`
          ...
          * { box-sizing:border-box; }
          ...
          .mt-searchfield:hover { background:rgba(255,255,255,0.11); border-color:rgba(255,255,255,0.26); box-shadow:inset 0 1px 3px rgba(0,0,0,0.24), 0 0 0 3px rgba(109,40,217,0.16); }
          .mt-searchfield:focus-visible { background:rgba(255,255,255,0.11); border-color:rgba(109,40,217,0.55); box-shadow:inset 0 1px 3px rgba(0,0,0,0.24), 0 0 0 3px rgba(109,40,217,0.22); }
